...
public class InterfaceInfoController {
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        YuApiClient temp=new YuApiClient(accessKey,secretKey);
        Gson gson=new Gson();
        com.yupi.yuapiclientsdk.model.User user1 = gson.fromJson(interfaceInfoInvokeRequest.getUserRequestParams(), com.yupi.yuapiclientsdk.model.User.class);
        String usernameByPost = temp.getUsernameByPost(user1);
